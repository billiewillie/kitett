...
import VyborRoddomaPageLayout from '~/layouts/VyborRoddomaPageLayout.vue';
import { useHead, useSeoMeta } from 'unhead';

useSeoMeta({
  ogTitle: 'Выбор роддома - Kitett',
  ...
  twitterTitle: 'Выбор роддома - Kitett',
