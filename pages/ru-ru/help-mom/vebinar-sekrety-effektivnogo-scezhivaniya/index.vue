<script setup>
import VebinarSekretyCcezhivaniyaPageLayout from '~/layouts/VebinarSekretyCcezhivaniyaPageLayout.vue';
...
useHead({
  title: 'Вебинар секреты эффективного сцеживания – Kitett',
  meta: [
    {
      name: 'description',
...
<template>
  <VebinarSekretyCcezhivaniyaPageLayout />
</template>