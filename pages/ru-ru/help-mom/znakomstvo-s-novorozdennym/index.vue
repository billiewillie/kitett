<script
  setup
  lang="ts">
import ZnakomstvoSNovorozdennymPageLayout from '~/layouts/ZnakomstvoSNovorozdennymPageLayout.vue';
...
useHead({
  title: 'Знакомство с новорожденным - Kitett',
  meta: [
    {
      name: 'description',
...
<template>
  <ZnakomstvoSNovorozdennymPageLayout />
</template>