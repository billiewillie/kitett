<script
  setup
  lang="ts">
import ZabotaOGrudiPageLayout from '~/layouts/ZabotaOGrudiPageLayout.vue';
import { useHead, useSeoMeta } from 'unhead';

useSeoMeta({
  ogTitle: 'Забота о груди – Kitett',
  ...
  twitterTitle: 'Забота о груди – Kitett',
