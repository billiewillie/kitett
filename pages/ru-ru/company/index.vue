<script setup>
import CompanyPageLayout from '~/layouts/CompanyPageLayout.vue';
...
useHead({
  title: 'Kitett – более 60 лет помогает в грудном вскармливании',
  meta: [
    {
      name: 'description',
      content: 'Бренд Kitett - №1 по выпуску молокоотсосов во Франции',
    },
    {
      name: 'keywords',
      content: 'Бренд Kitett - №1 по выпуску молокоотсосов во Франции',
