...
<!--      <br>-->
<!--      <br>-->
<!--      <p class="text-[14px] max-w-[600px]">* Данные Ассоциации банков грудного молока Северной Америки (www. hmbana. org), которые-->
...
<!--  <section class="mb-[75px]">-->
<!--    <div class="container">-->
<!--      <h2 class="title text-center uppercase text-[24px] lg:text-[30px]">Памятка по длительности хранения грудного молока</h2>-->
