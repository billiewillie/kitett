			...
			productList: [
				{
					id: 11,
					slug: 'fisio',
					title: 'Клинический молокоотсос FISIO®',
					fullTitle: 'Клинический электрический молокоотсос FISIO®',
					description: 'Молокоотсос Kitett FISIO® предназначен для использования в медицинских учреждениях. Благодаря легкости в настройке может быть использован мамой самостоятельно.',
					country: 'Франция',
					...
					set: '<ul>' +
						'<li>Основной прибор (Электрический молокоотсос FISIO®) (1шт.)</li>' +
						'<li>' +
						'<p>Набор для сцеживания KOLOR (1шт.)</p>' +
						'<ul>' +
						'<li>Воронка KOLOR размер 24L (1шт.)</li>' +
						'<li>Контейнер для сбора и хранения грудного молока, 100 мл (1шт.)</li>' +
						'<li>Крышка контейнера для хранения грудного молока (1шт.)</li>' +
				...
				},
				{
					id: 12,
					slug: 'fisio-pro',
					title: 'Клинический молокоотсос FISIO® PRO',
					fullTitle: 'Клинический электрический молокоотсос FISIO® PRO',
					description: 'Mолокоотсос Kitett FISIO® PRO предназначен для использования только в медицинских учреждениях. Помогает становлению и поддержанию необходимого уровня лактации.',
					country: 'Франция',
					material: 'Не содержит бисфенол-А',
					size: [
						{
					...
					set: '<ul>' +
						'<li>Основной прибор (Электрический молокоотсос FISIO PRO) (1шт.)</li>' +
						'<li>' +
						'<p>Набор для сцеживания KOLOR (1шт.)</p>' +
						'<ul>' +
						'<li>Воронка KOLOR размер 24L (1шт.)</li>' +
			...
			productList: [
				{
					id: 21,
					slug: 'kolor-play',
					title: 'Ручной молокоотсос KOLOR PLAY®',
					fullTitle: 'Ручной молокоотсос KOLOR PLAY®',
					description: 'Молокоотсос Kitett KOLOR PLAY® - это легкий и компактный ручной молокоотсос, простой в сборке и эксплуатации. Идеально подходит для эпизодических сцеживаний, незаменим во время длительных прогулок и путешествий.',
					country: 'Франция',
					material: 'Не содержит бисфенол-А',
					size: [
						{
					...
					set: '<ul>' +
						...
						'В случае необходимости воронки другого размера,\n' +
						'воронку можно заказать дополнительно</li>' +
					...
					instructions: [
						{
							...
							title: 'Инструкция по эксплуатации ручного молокоотсоса KOLOR PLAY®',
						},
						{
							id: 2,
							link: '../../../img/products/bytovye-molokootsosy/fisio/lineika_colorrama.pdf',
					...
					review:
						...
						'<p>Воспроизводит две фазы грудного вскармливания — стимуляцию и, непосредственно, само сцеживание.</p>' +
						'<br>' +
						'<h3 class="font-bold text-secondary">Контроль гигиены устройства</h3>' +
						...
						'<p>Форма контейнера для сбора молока и вакуумный модуль KOLOR CLIP разработаны с учётом анатомии женской руки, модуль работает мягко и беззвучно.</p>' +
						'<br>' +
						'<h3 class="font-bold text-secondary">Индивидуальные параметры молокоотсоса</h3>' +
						'<p>Вы можете выбрать размер воронки KOLOR, соответствующий форме и размеру вашей груди.</p>',
				},
				{
					id: 22,
					slug: 'minikit-solo',
					title: 'Электрический молокоотсос MINIKIT SOLO®',
					fullTitle: 'Электрический молокоотсос MINIKIT SOLO®',
					description: 'Молокоотсос Kitett MINIKIT SOLO — это портативный электрический молокоотсос, созданный для мам, ведущих активный образ жизни. Идеально подходит для частого и продолжительного применения дома и на работе.',
					country: 'Франция',
					material: 'Не содержит бисфенол-А',
					size: [
						{
					...
					set: '<ul>' +
						'<li>Основной прибор (Электрический молокоотсос MINIKIT SOLO) (1 шт.)</li>' +
					...
					instructions: [
						{
							...
							title: 'Инструкция по эксплуатации электрического молокоотсоса MINIKIT SOLO',
						},
						{
							id: 2,
							link: '../../../img/products/bytovye-molokootsosy/fisio/lineika_colorrama.pdf',
				...
				},
				{
					id: 23,
					slug: 'minikit-duo',
					title: 'Электрический молокоотсос двойного сцеживания MINIKIT DUO®',
					fullTitle: 'Двойной электрический молокоотсос MINIKIT DUO®',
					description: 'Молокоотсос Kitett MINIKIT DUO® — это портативный электрический молокоотсос двойного сцеживания. Идеален для стимуляции лактации, обеспечивает увеличение количества и улучшение качества молока.',
					country: 'Франция',
					...
					set: '<ul>' +
						'<li>Электрический молокоотсос MINIKIT DUO (1 шт.)</li>' +
					...
					instructions: [
						{
							...
							title: 'Инструкция по эксплуатации электрического молокоотсоса MINIKIT DUO',
						},
						{
							id: 2,
							link: '../../../img/products/bytovye-molokootsosy/fisio/lineika_colorrama.pdf',
			...
			productList: [
				{
					...
					slug: 'voronki-kolor',
					title: 'Воронки KOLOR®',
					fullTitle: 'Воронки для сцеживания KOLOR®',
					...
					review:
						...
						'<p>Правильно подобранная воронка KOLOR герметично прилегает к груди благодаря вакууму, создающемуся внутри устройства. Стимулирование нужных долей молочной железы обеспечивает хороший объём сцеженного молока.</p>' +
						'<br>' +
						'<h3 class="font-bold text-secondary">Безопасность для малыша и мамы</h3>' +
						'<p>В составе воронок KOLOR нет фталатов и бисфенола А, поэтому их без опасения можно использовать на протяжении всего периода применения молокоотсоса.</p>',
				},
				{
					id: 32,
					slug: 'nabor-kolor',
					title: 'Набор для сцеживания KOLOR®',
					fullTitle: 'Набор для сцеживания KOLOR®',
					description: 'Набор для сцеживания KOLOR для клинических молокотсосов FISIO® и FISIO® PRO предназначен к использованию в медицинских учреждениях. После выписки он может использоваться дома с бытовыми молокоотсосами KOLOR PLAY® и MINIKIT SOLO.',
					country: 'Франция',
					material: 'Воронки KOLOR® не содержат бисфенола-А и фталатов',
					size: [
						{
					...
					set:
						'<ul>' +
						'<li>Воронка KOLOR (1шт.) / Воронка KOLOR автоклавируемая (1шт.)</li>' +
						'<li>Контейнер для сбора и хранения грудного молока, 100 мл (1шт.)</li>' +
						'<li>Крышка контейнера для хранения грудного молока (1шт.)</li>' +
						'<li>Соединительная трубка (1шт.)</li>' +
						'<li>Флакон-переходник (1шт.)</li>' +
				...
				},
				{
					id: 33,
					slug: 'fisio-bib',
					title: 'Контейнеры для грудного молока FISIO® BIB',
					fullTitle: 'Контейнеры для грудного молока FISIO® BIB',
					description: 'Грудное молоко – бесценный продукт, который требует правильного и безопасного хранения. Контейнеры для сбора и хранения грудного молока FISIO® BIB сохраняют все полезные свойства молока, которые так важны для Вашего малыша.',
					country: 'Франция',
					material: 'Не содержит бисфенола-А и фталатов',
					size: [
						{
					...
					review:
						...
						'<h3 class="font-bold text-secondary">Безопасные материалы</h3>' +
						'<p>Контейнеры для сбора и хранения грудного молока FISIO® BIB совместимы со всеми молокоотсосами Kitett: с ручным KOLOR PLAY, с электрическими MINIKIT SOLO, FISIO® и FISIO®  PRO.</p>',
				},
				{
					id: 34,
					slug: 'fisio-fresh',
					title: 'Набор FISIO® FRESH для охлаждения и транспортировки грудного молока',
					fullTitle: 'Набор FISIO FRESH для охлаждения и транспортировки грудного молока',
					description: 'В состав набора FISIO® FRESH входят аккумуляторы холода, контейнеры для сбора и хранения грудного молока и термосумка. Контейнеры вместе с аккумуляторами холода легко помещаются в компактную термосумку. Благодаря надежной упаковке, транспортировка грудного молока пройдет безопасно, а время охлаждения и хранения будет продлено.',
					country: 'Франция',
					material: 'Не содержит бисфенола-А и фталатов',
					size: [
						{
					...
					set:
						'<ul>' +
						'<li>Термосумка (1шт.)</li>' +
						'<li>Контейнеры FISIOBIB для сбора и хранения грудного молока, 100 мл c крышкой (4 шт.)</li>' +
				...
				},
				{
					id: 35,
					slug: 'fisio-lan',
					title: 'Крем FISIO LAN',
					fullTitle: 'Крем для груди FISIO® LAN',
					...
					instructions: [
						{
							id:
								1,
							text:
								'Ланолин обеспечивает комфорт и защиту для сухой кожи мам. Необходимо наносить крем на кожу сосков после каждого использования молокоотсоса. Не нужно смывать перед кормлением. Перед использованием вымыть руки.',
						},
					],
					review:
						'<h3 class="font-bold text-secondary">100% натуральный продукт</h3>' +
						'<p>Крем для ухода за сосками FISIO LAN на 100% состоит из ланолина – природного смягчающего вещества. Не содержит в своем составе красителей и отдушек.</p>' +
						'<br>' +
				...
				},
				{
					id: 36,
					slug: 'fisio-pad',
					title: 'Прокладки FISIO® PAD',
					fullTitle: 'Лактационные одноразовые прокладки FISIO® PAD',
