		...
		},
		{
			...
			productList: [
				...
				},
				{
					...
					fullTitle: 'Контейнеры для молока FISIO BIB',
					...
					review:
						...
						'<h3 class="font-bold text-secondary">Безопасные материалы</h3>' +
						'<p>Контейнеры для сбора и хранения грудного молока FISIOBIB совместимы со всеми молокоотсосами Kitett: с ручным KOLOR PLAY, с электрическими MINIKIT SOLO, FISIO и FISIO PRO.</p>',
				},
				{
					id: 34,
					slug: 'fisio-fresh',
