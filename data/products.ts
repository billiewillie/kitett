			...
			productList: [
				{
					...
					descriptionNoTags: 'Молокоотсос Kitett FISIO предназначен для использования в медицинских учреждениях. Благодаря легкости в настройке может быть использован мамой самостоятельно.',
				...
				},
				{
					...
					descriptionNoTags: 'Mолокоотсос Kitett FISIO PRO предназначен для использования только в медицинских учреждениях. Помогает становлению и поддержанию необходимого уровня лактации.',
			...
			productList: [
				{
					...
					descriptionNoTags: 'Молокоотсос Kitett KOLOR PLAY - это легкий и компактный ручной молокоотсос, простой в сборке и эксплуатации. Идеально подходит для эпизодических сцеживаний, незаменим во время длительных прогулок и путешествий.',
					...
					set: '<ul>' +
						...
						'<li>Воронка KOLOR (1 шт.), размер на выбор:</li>' +
						'</ul>',
				...
				},
				{
					...
					descriptionNoTags: 'Молокоотсос Kitett MINIKIT SOLO — это портативный электрический молокоотсос, созданный для мам, ведущих активный образ жизни. Идеально подходит для частого и продолжительного применения дома и на работе.',
				...
				},
				{
					...
					descriptionNoTags: 'Молокоотсос Kitett MINIKIT DUO — это портативный электрический молокоотсос двойного сцеживания. Идеален для стимуляции лактации, обеспечивает увеличение количества и улучшение качества молока.',
					...
					set: '<ul>' +
						...
						'<li>Сетевой адаптер (1 шт.)</li>' +
						'<li>Сумка для хранения принадлежностей (1 шт.)</li>' +
						'<li>Воронка KOLOR (2 шт.), размеры на выбор:</li>' +
						'</ul>',
			...
			productList: [
				{
					...
					descriptionNoTags: 'Идеально подобранная воронка сделает сцеживание комфортным и продуктивным, а также исключит любое травмирование нежной и чувствительной кожи груди.',
				...
				},
				{
					id: 32,
					slug: 'nabor-kolor',
					titleNoTags: 'Набор для сцеживания KOLOR',
					...
					descriptionNoTags: 'Набор для сцеживания KOLOR для клинических молокотсосов FISIO и FISIO PRO предназначен к использованию в медицинских учреждениях. После выписки он может использоваться дома с бытовыми молокоотсосами KOLOR PLAY и MINIKIT SOLO.',
					...
					review:
						'<p>Мама может получить в пользование стерильный набор для сцеживания в родильном доме, где установлены клинические молокоотсосы Kitett ' +
						'или приобрести индивидуальный набор для сцеживания Kitett<sup>®</sup> KOLOR, чтобы впоследствии использовать индивидуально подобранную воронку ' +
						'и контейнер для молока дома, с бытовым молокоотсосом Kitett<sup>®</sup>.</p>'
				},
				{
					id: 33,
					slug: 'fisio-bib',
					titleNoTags: 'Контейнеры для грудного молока FISIO BIB',
					...
					descriptionNoTags: 'Грудное молоко – бесценный продукт, который требует правильного и безопасного хранения. Контейнеры для сбора и хранения грудного молока FISIO BIB сохраняют все полезные свойства молока, которые так важны для вашего малыша.',
					...
					review:
						...
						'<p>Вместе с Kitett<sup>®</sup> вы сможете создать собственный банк грудного молока, который позволит ' +
						'продлить период грудного вскармливания, а также спокойно отлучаться по делам, предоставляя другим членам семьи счастливую возможность участвовать в кормлении малыша.</p>' +
						'<br>' +
						...
						'<br>' +
						'<h3 class="font-bold text-secondary">Совместимость с молокоотсосами</h3>' +
						'<p>Контейнеры для сбора и хранения грудного молока FISIO<sup>®</sup>BIB совместимы со всеми молокоотсосами Kitett: с ручным KOLOR PLAY<sup>®</sup>, с электрическими MINIKIT SOLO<sup>®</sup>, FISIO<sup>®</sup> и FISIO<sup>®</sup>  PRO.</p>',
				},
				{
					id: 34,
					slug: 'fisio-fresh',
					titleNoTags: 'Набор FISIO FRESH для охлаждения и транспортировки грудного молока',
					...
					set:
						...
						'<li>Аккумуляторы холода FISIO<sup>®</sup>COOL (4 шт.)</li>' +
						'<li>Сумка для хранения принадлежностей (1 шт.)</li>' +
						'</ul>',
					...
					review:
						...
						'<p>Набор FISIO<sup>®</sup>FRESH позволяет компактно расположить и удобно транспортировать грудное молоко.</p>' +
						'<br>' +
						'<h3 class="font-bold text-secondary">Износостойкость</h3>' +
						'<p>Термосумка и контейнеры FISIO<sup>®</sup>BIB подходят для многократного использования.</p>',
				},
				{
					id: 35,
					slug: 'fisio-lan',
					titleNoTags: 'Крем FISIO LAN',
					...
					descriptionNoTags: 'Во время кормления грудью чувствительность сосков повышается, возможны болезненные ощущения - воспаление или возникновение трещин. С помощью Kitett Вы сможете начать заботиться о нежной коже груди еще до рождения малыша и продолжать уход весь период грудного вскармливания, чтобы предотвратить возможные неприятные ощущения.',
					description: 'Во время кормления грудью чувствительность сосков повышается, возможны болезненные ощущения - воспаление или возникновение трещин. С помощью Kitett<sup>®</sup> Вы сможете начать заботиться о нежной коже груди еще до рождения малыша и продолжать уход весь период грудного вскармливания, чтобы предотвратить возможные неприятные ощущения.',
					country: 'Франция',
					...
					review:
						...
						'<p>Крем для ухода за сосками FISIO<sup>®</sup>LAN на 100% состоит из ланолина ' +
						'– природного смягчающего вещества. Не содержит в своем составе красителей и отдушек.</p>' +
						'<br>' +
				...
				},
				{
					id: 36,
					slug: 'fisio-pad',
					titleNoTags: 'Прокладки FISIO PAD',
					...
					descriptionNoTags: 'Незаметная, нежная и деликатная защита от подтекания молока из груди',
