...
export const COMMON_STATEMENTS = [
  ...
  {
    id: 2,
    text: 'В целях соблюдения норм гигиены, воронки KOLOR® выполнены в формате неразборной конструкции. Это позволяет избежать прикосновений пальцев рук к внутренней части воронки и винтовой резьбе контейнера.',
  },
  {
    id: 3,
  ...
  {
    id: 5,
    text: 'В составе воронок KOLOR® нет фталатов и бисфенола, что важно для новорождённого.',
  },
  {
    id: 6,
